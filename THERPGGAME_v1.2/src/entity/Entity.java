...
public class Entity {
	...
	public final int type_staff = 4;
	public final int type_armor = 5;
	public final int type_consumable = 6;
	public final int type_pickUpOnly = 7;
	public final int type_obstacle = 8;
	public final int type_light = 9;
	public final int type_bow = 20;
	...
	public int getXdiatance(Entity target) {
		int xDistance = Math.abs(worldX - target.worldX);
		return xDistance;
	}
	public int getYdiatance(Entity target) {
		int yDistance = Math.abs(worldY - target.worldY);
		return yDistance;
	}
	public int getTileDistance(Entity target) {
		int tileDiatance = (getXdiatance(target)+getYdiatance(target))/gp.tileSize;
		return tileDiatance;
	}
	...
	public void dropItem(Entity droppedItem) {
		...
		for(int i = 0; i < gp.obj[1].length; i++) {
			if(gp.obj[gp.currentMap][i] == null) {
				...
				gp.obj[gp.currentMap][i].worldX = worldX; //the dead monster's world X
				gp.obj[gp.currentMap][i].worldY = worldY; //the dead monster's world Y
				break;
			}
		}
	}
	...
	public void generateParticle(Entity generator, Entity target) {
		...
		Particle p1 = new Particle(gp, target, color, size, speed, maxLife, (int)-1.5, -1);
		Particle p2 = new Particle(gp, target, color, size, speed, maxLife, (int)1.5, -1);
		Particle p3 = new Particle(gp, target, color, size, speed, maxLife, (int)-1.5, 1);
		Particle p4 = new Particle(gp, target, color, size, speed, maxLife, (int)1.5, 1);
	...
	public void checkAttackOrNot(int rate, int straight, int horizontal) {
		boolean targetInGange=false;
		int xDis= getXdiatance(gp.player);
		int yDis=getYdiatance(gp.player);
		switch(direction) {
		case "up":
...
//			gp.projectileList.add(projectile);
	...
	public void damagePlayer(int attack) {
		...
		if(gp.player.invincible == false) {
			...
			//Get an oppsite direction of this attacker
